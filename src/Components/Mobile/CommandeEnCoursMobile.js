...
function CommandeEnCoursMobile({commande,count,next,previous,handledisplay}) {
  return (
 ...
 <p className='centerbtn'>
  ...
  to={`/detail/${ach.produitcommande.product.slug}/${ach.produitcommande.product.nom}`}>
    <p className='centerbtn'> <strong  className='logocolor'>{ach.produitcommande.product.nom}</strong></p></Link>
    <p className='centerbtn'>
     Couleur <strong> 
