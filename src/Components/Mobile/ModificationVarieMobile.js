...
function ModificationVarieMobile({produit,produitimg,location,category,devise,handlesubmitmodifvarie,
...
return(
 ...
 <ModifAvecVariation produit={produit} produitimg={produitimg} location={location} devise={devise}
  ...
  modifimgvarie={modifimgvarie} suppressionimgvarie={suppressionimgvarie} images={images}
   ...
   <button className='btnsupprimermobile' onClick={suppressionproduit}>
...
export default ModificationVarieMobile
...
<div >
 ...
 {images.map((img,index)=>
  ...
  alt="" 
  className="imgboutiquemobilejout"/>
   <p>
<Button
className='btndrop'
 component="label">
