...
function VendreMobile() {
  ...
  <h4 className='textpage'> Vous etes au bon endroit.<span className='logocolor'>Gaalguishop</span> met à votre disposition une boutique en ligne ou vos produits sont vus par des milliers de personne et peuvent etre achetés en toute sécurité et cela en quelques clics de votre part.
