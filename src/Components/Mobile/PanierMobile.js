...
function PanierMobile({cartproduit, handleplus, handleminus,handleremove,truncateString
  ,cart,handlecommande,handleplunique,count,next,previous,handledisplay}) {
  return( 
  <div className='mobile '>
    ...
    {cart.product.variation===true?
     ...
     to={`detail/${cart.imageproduct.produit.slug}/${cart.imageproduct.produit.nom}`}>
      ...
      <p>{truncateString(cart.imageproduct.produit.description,50)}</p></Link>
       ...
       <IonCol size='4'>
      <img src={`https://gaalguishop.herokuapp.com${cart.imageproduct.image}`} alt='' className='imgpaniermobile' />
      </IonCol>
      <IonCol size='4'>
      ...
      onClick={()=>handlecommande(cart.id ,cart.imageproduct.produit.nom,cart.imageproduct.produit.slug)}>
        ...
        Diminuez la quantite pour pouvoir  commander  ce produit</IonText></span>}
        <br/><br/>
   ...
   <IonCol size='4'>
    ...
    <IonCol size='4'>
    <img src={`https://gaalguishop.herokuapp.com${cart.product.thumbnail}`} alt='' className='imgpaniermobile' />
    </IonCol>
    <IonCol size='4'>
     {cart.product.active?
       <p>
    ...
    </div>:<h1>Oups votre panier est vide <Link to='/' className='linkpanier'> Commencez vos Shoppings</Link>
    </h1>}
