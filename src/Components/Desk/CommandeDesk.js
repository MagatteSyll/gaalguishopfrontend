      ...
      <IonCol size='5'>
       <p>{produit.imageproduct.produit.nom}</p>
        ...
        <p>Montant total <strong>
            ...
            {calculer?
            <div> <p>Livraison <strong>{livraison} {produit.imageproduct.produit.devise.devise} </strong> 
          ...
          <IonRow>
            ...
            <p>Prix unitaire <strong>{produit.product.prix} {produit.product.devise.devise} 
             ...
             <p> Total <strong> 
              ...
              {calculer?
              <div> <p>Livraison <strong>{livraison} {produit.product.devise.devise}  </strong> </p>
